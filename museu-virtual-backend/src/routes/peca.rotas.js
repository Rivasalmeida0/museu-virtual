...
roteador.post('/',                       verificarToken, apenasAdmin, registarActividade('CRIAR_PECA', 'pecas'), Controlador.criar);
roteador.put('/:id',                     verificarToken, apenasAdmin, registarActividade('ACTUALIZAR_PECA', 'pecas'), Controlador.actualizar);
roteador.delete('/:id',                  verificarToken, apenasAdmin, registarActividade('REMOVER_PECA', 'pecas'), Controlador.desactivar);
